...
В ответ могут быть получены статусы: 200 и 400.
...
В ответ могут быть получены статусы: 200, 400, 404.
...
- ***400*** - говорит об ошибке удаления по одной из причин:
    ...
    * "Media file is currently in use" - если данный медиафайл сейчас используется где-то в трансялции или запланирован использоваться на будущее
...
- ***400*** - говорит об ошибке загрузке по одной из причин:
    ...
    * "Source file is not a video" - указанный файл не является видеофрагментов
...
- ***400*** - говорит об ошибке перемещения по одной из причин:
    ...
    * "Date is not correct" - некорректное значение даты и времени
    * "TimeZone is not correct" - несуществубщий часовой пояс
    * "The new date and time have already passed" - новые дата и время уже наступили или прошли
    * "The old date and time have already passed" - старые дата и время сейчас идут или уже прошли
...
{
    {
        ...
        "using": 0              // Используемость файла (0 - не используется, 1 - используется)
    },
    {
        "file_type": "",
        "file_name": "",
